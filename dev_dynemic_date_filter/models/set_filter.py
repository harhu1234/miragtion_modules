...
class set_filter(models.Model):
	...
	filter_field = fields.Many2one('ir.model.fields', string='Filter Field', required="1")
	...
	this_month = fields.Boolean('This Month') # This month
	...
	last_month = fields.Boolean('Last Month') # Last Month
